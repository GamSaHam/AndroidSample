        ...
        public void run()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    String strBuffer = bytes2String(buffer, bytes);

                    String[] strArray = strBuffer.split("-");

                    for(int i=0;i<strArray.length;i++)
                    {
                       Log.v("Log",strArray[i].toString()) ;

                    }


                   // Intent intent = new Intent("com.test.bluetoothtest1.receive");
